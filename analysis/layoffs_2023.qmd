...
my_colors <- c("darkblue", "darkslategray4", "darkslategray2", "azure3", "aquamarine2", "cornflowerblue", "cadetblue2","blue1","cyan","deepskyblue1","lightblue", "deepskyblue", "azure1", "aquamarine", "cadetblue", "blue2","cyan1", "deepskyblue2", "darkslategray1", "azure2", "aquamarine3", "cadetblue3", "blue3", "cyan2", "deepskyblue3", "darkslategray3", "azure", "cyan3", "blue4", "deepskyblue4", "cadetblue4", "yellow", "lightyellow")
```
